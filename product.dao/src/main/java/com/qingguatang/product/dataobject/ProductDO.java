...
public class ProductDO {
  ...
  public Product convert() {
    ...
    product.setGmtModified(gmtModifiled);
    product.setTitle(getTitle());
    product.setAccountId(getAccountId());
    product.setCategoryId(getCategoryId());
    product.setShowPrice(getShowPrice());
    product.setLinePrice(getLinePrice());
    product.setSoldQuantity(getSoldQuantity());
    product.setStock(getStock());
    product.setMainPictUrl(getMainPictUrl());
    product.setOnlineTime(getOnlineTime());
    product.setOfflineTime(getOfflineTime());
    product.setStatus(ProductStatus.valueOf(getStatus()));
